-- Keep the public model catalog and the atomic database charge policy aligned.
-- Luna joins the free pool; premium models retain Founder Pro enforcement.
...
comment on function public.civil_consume_answer_credits(text, text, text) is
  'Atomically reserves weighted answer credits; Luna and DeepSeek Flash are free-tier models.';
