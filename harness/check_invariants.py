...
def check_product_contract() -> Check:
    ...
    required = {
        ...
        "seedy_application_isolation": not (ROOT / "citymcp" / "ops-dashboard" / "package.json").exists(),
        "seedy_workflow_isolation": not any((ROOT / ".github" / "workflows").glob("citymcp-*.yml")),
        "archive_recovery_documented": (ROOT / "docs" / "LEGACY_COMPATIBILITY.md").exists(),
