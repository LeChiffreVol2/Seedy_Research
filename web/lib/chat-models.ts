export const OPENAI_CHAT_MODELS = [
  ...
  { id: "gpt-5.6-terra", label: "GPT-5.6 Terra", provider: "openai", credits: 5, requiresPro: false },
  { id: "gpt-5.6-sol", label: "GPT-5.6 Sol", provider: "openai", credits: 10, requiresPro: false },
] as const;
...
export const DEEPSEEK_CHAT_MODELS = [
  ...
  { id: "deepseek-v4-pro", label: "DeepSeek V4 Pro", provider: "deepseek", credits: 2, requiresPro: false },
] as const;
