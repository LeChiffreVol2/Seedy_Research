...
export const metadata: Metadata = {
  title: "Privacy | CivilMCP",
  description: "How CivilMCP handles account, research, and usage data.",
};
...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      intro="Effective August 12, 2026. CivilMCP is a public research preview, and this notice describes the data needed to operate it."
    >
      <section>
        <h2>What we store</h2>
